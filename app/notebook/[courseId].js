...
export default function NotebookModules() {
  ...
  return (
    <SafeScreen>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle} numberOfLines={1}>{course.title} Notebook</Text>
        <View style={{ width: 24 }} />
      </View>

      <ScrollView contentContainerStyle={styles.container}>
        <EmojiText style={styles.subtitle}>
          Select a topic to read program solutions! 📚
        </EmojiText>
        ...
        {course.modules.map((module) => {
          ...
          return (
            <TouchableOpacity 
              key={module.moduleId} 
              style={styles.card}
              onPress={() => router.push(`/notebook/${courseId}/${module.moduleId}`)}
              activeOpacity={0.7}
            >
